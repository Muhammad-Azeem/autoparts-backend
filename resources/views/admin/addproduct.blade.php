        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-right">
                                <div class="actions">
                                    <div class="actions">
                                        <a href="{{ route('ad-product') }}" class="btn btn-inverse pull-right">Add Product</a>
                                        <a href="{{ route('product_list') }}" class="btn btn-success pull-right">Product List</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('ad-product') }}" enctype="multipart/form-data">
                            @csrf
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-row">
                                                                <div class="form-group col-lg-12">
                                                                    <textarea rows="6" name="schema[]" class="form-control" placeholder="Type Your Schema Quotes here...">{{ $schemas['code'] ?? ''   }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
